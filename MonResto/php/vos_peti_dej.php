										...
										<table class="table">
											...
											{	
													...
													
												{
													...
													$insertion = "SELECT *,SUM(prix) AS total_prix FROM mes_resto,petit_dej WHERE petit_dej.resto_id = :resto_id AND mes_resto.nom_resto = :nom_resto AND nom = :valeur ";
